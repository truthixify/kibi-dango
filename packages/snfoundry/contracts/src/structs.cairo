//! # Structs Module
//!
//! This module contains shared data structures used across the Kibi Dango contracts.
//! These structs define the core data models and state representations used
//! throughout the game ecosystem.
//!
//! ## Modules:
