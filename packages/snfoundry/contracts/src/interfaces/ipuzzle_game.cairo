...
pub trait IPuzzleGame<TContractState> {
    ...
    //! Set the KibiToken contract address
    //!
    //! ## Parameters:
    //! - **kibi_token**: The address of the KibiToken contract
    //!
    //! ## Security:
    //! - Only callable by the contract owner
    //! - Used to establish the connection with the reward token contract
    ...
    //!
    //! ## Returns:
    //! - The next puzzle ID that will be assigned to a new puzzle
    //!
    //! ## Usage:
    ...
    //!
    //! ## Returns:
    //! - Complete puzzle data including solution commitment, reward, and status
    //!
    //! ## Usage:
