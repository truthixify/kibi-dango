//! # Enums Module
//!
//! This module contains shared enums used across the Kibi Dango contracts.
//! These enums define the core data types and states used throughout the game ecosystem.
//!
//! ## Modules:
