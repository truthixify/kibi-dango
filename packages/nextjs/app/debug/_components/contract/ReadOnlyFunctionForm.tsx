...
export const ReadOnlyFunctionForm = ({
    ...
    return (
        <div className="flex flex-col gap-3 py-5 first:pt-0 last:pb-1">
            <p className="text-function my-0 break-words font-medium">{abiFunction.name}</p>
            {inputElements}
            <div className="flex flex-wrap justify-between gap-2">
                <div className="w-4/5 flex-grow">
                    {data !== null && data !== undefined && (
                        <div className="bg-input break-words px-4 py-1.5 text-sm">
                ...
                >
                    <button
                        className="btn btn-sm border-none bg-gradient-dark text-white shadow-none"
                        onClick={handleRead}
