...
const deployedContracts = {
  devnet: {
    KibiToken: {
      address:
        "0x52955d71c6fd42b016ff5949c1db9645eb4a7ea2e886712d196bec126437c9b",
      abi: [
        {
          type: "impl",
          name: "KibiTokenImpl",
    ...
    PirateNFT: {
      address:
        "0x3e44a5b51d09b505a2a1eb7ce575ac153e759fae6e3e27f557d52a9090ebfec",
      abi: [
        {
          type: "impl",
          name: "PirateNFTImpl",
    ...
    KibiBank: {
      address:
        "0x2ba92fb5c1e36d1d80ff098b521fd06d6a2e9da1d544d182a74fa68a3865a86",
      abi: [
        {
          type: "impl",
          name: "KibiBankImpl",
    ...
    PuzzleGame: {
      address:
        "0x3a3177e004c90b92be7ca5e6cbf7c61c9727c1b8af8085f2b66bf6c7e12a4f5",
      abi: [
        {
          type: "impl",
          name: "PuzzleGameImpl",
      ...
      classHash:
        "0x50a00594833bc7bedba1e12ce2ff40f5eea787bd805a074f1d2dec2a13e242f",
    },
  },
  sepolia: {
    KibiToken: {
      address:
        "0x4223b6448413d38033525781fdd3a23a46b513850157b23a89a250d7f7a8287",
      abi: [
        {
          type: "impl",
          name: "KibiTokenImpl",
    ...
    PirateNFT: {
      address:
        "0x7c3aeda775ebeda9e7b084a2965c3d1fbf32eaa91caf48d6c6deae4dfbd265d",
      abi: [
        {
          type: "impl",
          name: "PirateNFTImpl",
    ...
    KibiBank: {
      address:
        "0x25336574a4bb8a23ae31ad4dab80a688af17948dc740ba14a219baa2744dae5",
      abi: [
        {
          type: "impl",
          name: "KibiBankImpl",
    ...
    PuzzleGame: {
      address:
        "0x16c9c69d1f1afe0cbd8b1e521df2b4823b3519c05f51f22451fee382ea9762c",
      abi: [
        {
          type: "impl",
          name: "PuzzleGameImpl",
